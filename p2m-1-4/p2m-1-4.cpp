...
void usage(void)
{
    ...
    cout << "     4 - deLay after each element.\n";
    ...
    cout << "-l - delay after each element = 0 (in mode 4);\n";
...
int main(int argc, char *argv[])
{
    ...
    cout << "Processor-to-memory copy test. 64-bit. Version 1.4\n";

    while ( (rez = getopt(argc,argv,"s:t:m:d:l:v?h")) != -1){
        switch (rez){
        case 's':
