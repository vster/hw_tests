...
void usage(void)
{
   ...
   cout << "-h - help\n";
   cout << "*******************************************************************************\n";
   cout << "If you start this program without any options it works with default parameters.\n";
...
int main(int argc, char *argv[])
{
    ...
    cout << "Memory-to-memory copy test. 64-bit. Version 1.1\n";
