...
static size_t asize;
static u64bit src[MAXSIZE];
static u64bit src0[MAXSIZE];
...
void m2p_u64bit_1 (void)
{
    register u64bit tcr=0;
...
int main(int argc, char *argv[])
{
    ...
    cout << "Memory-to-processor test. 64-bit. Version 1.1\n";
      ...
      switch (ch)
      {
        case 'r':
            ...
            while(!kbhit())
            {
                switch (test_mn)
                {
                    case 1: m2p_u64bit_1(); break;
                    case 2: m2p_u64bit_2(); break;
                    case 3: m2p_u64bit_3(); break;
                }
